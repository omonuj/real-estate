    ...
    p-14 md:px-20 lg:px-32 w-full overflow-hidden' id='About'>
        ...
        <div className='flex flex-col md:flex-row items-center md:items-start md:gap-20'>
            ...
            <div className='flex flex-col items-center md:items-start mt-10 text-gray-600'>
                <div className='grid grid-cols-2 gab-6 md:gab-10 w-full 2xl:pr-28 '>
                    <div>
                ...
                <div>
                    <p className='my-10 max-w-lg'>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                        Lorem Ipsum has been the industry's standard dummy text ever since the 19500s, 
                        when an unknown printer took a galley of type and scambled it to make a type specimen book.
                    </p>
