    ...
    overflow-hidden' id='Footer'>
        ...
        md:flex-row justify-between items-start'>
            <div className='w-full md:w-1/3 mb-8 md:mb-0'>
                ...
                <p className='text-gray-400 mt-4'>We supply Industry Standard Houses that are upto date</p>
            </div>
            <div className='w-full md:w-1/5 mb-8 md:mb-0'>
                ...
                <ul className='flex flex-col gap-2 text-gray-400'>
                    ...
                    <a href="#Private" className='hover:text-white'>Private Policy</a>
                </ul>
            </div>
            ...
            <div className='flex gap-2'>
                ...
                <button className='py-2 px-4 rounded-lg bg-blue-500 text-white '>Suscribe</button>
            </div>

            </div>
        </div>
        <div className='border-t border-gray-700 py-4 mt-10 text-center text-gray-500'>
            Copyright 2024 @ JonahRealEstate. A limited Liability. All Rght Reserved.
        </div>
    </div>
  )
}
