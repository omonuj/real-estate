...
const Contact = () => {
  return (
    <div className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden' id='Contact'>
        ...
        <p className='text-center text-gray-500 bm-12 max-w-80 mx-auto'
        >Ready to make a move? Let's Build Your Future Together</p>

        <form className='max-w-2xl mx-auto text-gray-600 pt-8'  action="https://formspree.io/f/xrbgrvda"
  method="POST">
            ...
            <button className='bg-blue-600 text-white py-2 px-12 mb-10 rounded' type='submit'>Send Messsage</button>
