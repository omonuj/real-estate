    ...
    <div className='absolute top-0 left-0 w-full z-10'>
        <div className='container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent'>
            ...
            <ul className='hidden md:flex gap-7 text-white'>
                ...
                <a href="#Projrcts" className='cursor-pointer hover:text-gray-400'>Projects</a>
        ...
        bottom-0 overflow-hidden bg-white transition-all`}>
          ...
          '>
            ...
            <a onClick={()=>setShowMobileMenu(false)}  href="#About" className='px-4 py-2 rounded-full inline-block'>Text About</a>
